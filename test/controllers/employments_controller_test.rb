...
class EmploymentsControllerTest < ActionController::TestCase
  ...
  test "should create employment" do
    assert_difference('Employment.count') do
      post :create, employment: { company: @employment.company, description: @employment.description, position: @employment.position }
    end
  ...
  test "should update employment" do
    patch :update, id: @employment, employment: { company: @employment.company, description: @employment.description, position: @employment.position }
    assert_redirected_to employment_path(assigns(:employment))
  end
