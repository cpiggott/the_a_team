...
class StudiesControllerTest < ActionController::TestCase
  ...
  test "should create study" do
    assert_difference('Study.count') do
      post :create, study: { date: @study.date, description: @study.description, location: @study.location, name: @study.name }
    end
  ...
  test "should update study" do
    patch :update, id: @study, study: { date: @study.date, description: @study.description, location: @study.location, name: @study.name }
    assert_redirected_to study_path(assigns(:study))
  end
